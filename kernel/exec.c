...
exec(char *path, char **argv)
{
  ...
  //TODO also not very effective
  //proc_freepagetable(oldpagetable, oldsz);
  //Reusing the old address space
  //if(p->asid != 0)
...
//TODO Change interface to use asids rather than pagetables
static int
loadseg(pagetable_t pagetable, vaddr va, struct inode *ip, uint offset, uint sz)
{
  ASSERT_VIRTUAL(va)
  uint i, n;
  uint64 pa;
